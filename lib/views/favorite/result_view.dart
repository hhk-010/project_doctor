    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          backgroundColor: Colors.deepOrange,
          title: Text(
            LocaleKeys.view_search_result_list_doctor_info.tr(),
            style: TextStyle(
            ...
            IconButton(
              onPressed: () async {
                ...
                if (!FavoriteTile.favoriteListSelected) {
                  ...
                  _error = LocaleKeys.view_search_result_list_removed_successfully.tr();
                  _showSnackBar();
                }
              },
              icon: Icon(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        (SearchResultData.speciality).tr(),
                        style: TextStyle(
                          fontSize: getDeviceType(context, 12, 15, 18, 21),
                          fontWeight: FontWeight.bold,
                          fontFamily: 'noto_arabic',
                      ...
                      Text(
                        SearchResultData.distance.toString() + " " + LocaleKeys.view_patient_result_km.tr(), //' Km away',
                        style: TextStyle(
                          fontSize: getDeviceType(context, 12, 15, 18, 21),
                          fontWeight: FontWeight.bold,
                          fontFamily: 'noto_arabic',
