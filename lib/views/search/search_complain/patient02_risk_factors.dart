      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: FittedBox(
            fit: BoxFit.fitWidth,
            child: Text(
              LocaleKeys.chronic_diseases_choose_one_more.tr(),
                          ...
                          children: [
                            Padding(
                              ...
                              child: FittedBox(
                                fit: BoxFit.fitWidth,
                                child: Text(
                                  LocaleKeys.chronic_diseases_chronic_disease.tr(),
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_HTN.tr(),
                                ),
                                value: htnSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_DM.tr(),
                                ),
                                value: dmSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_heart.tr(),
                                ),
                                value: chdSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_heartFailure.tr(),
                                ),
                                value: hfSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_ctd.tr(),
                                ),
                                value: ctdSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_ckd.tr(),
                                ),
                                value: ckdSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_liver.tr(),
                                ),
                                value: ldSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_lung.tr(),
                                ),
                                value: copdSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_ashma.tr(),
                                ),
                                value: ashmaSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_thyroid.tr(),
                                ),
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_epilepsy.tr(),
                                ),
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_intestine.tr(),
                                ),
                                value: cidSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_cva.tr(),
                                ),
                                value: cvaSelected,
                                onChanged: (val) {
                                  setState(() {
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_cd_tumor.tr(),
                                ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: FittedBox(
                                fit: BoxFit.fitWidth,
                                child: Text(
                                  LocaleKeys.chronic_diseases_life_style.tr(),
                                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
                                ),
                              ),
                            ),
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_obesity.tr(),
                                ),
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_physical_inactive.tr(),
                                ),
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_alcohol.tr(),
                                ),
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_smoking.tr(),
                                ),
                            ...
                            CheckboxListTile(
                                title: Text(
                                  LocaleKeys.chronic_diseases_family.tr(),
                                ),
                            ...
                            gender == "Female"
                                ? CheckboxListTile(
                                    title: Text(
                                      LocaleKeys.chronic_diseases_pregnancy.tr(),
                                    ),
