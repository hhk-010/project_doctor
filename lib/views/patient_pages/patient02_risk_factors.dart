...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('cd_DM'),
//                                 ),
//                                 value: dmSelected,
//                                 onChanged: (val) {
//                                   setState(() {
...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('cd_heart'),
//                                 ),
//                                 value: chdSelected,
//                                 onChanged: (val) {
//                                   setState(() {
...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('cd_heartFailure'),
//                                 ),
//                                 value: hfSelected,
//                                 onChanged: (val) {
//                                   setState(() {
...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('cd_lung'),
//                                 ),
//                                 value: copdSelected,
//                                 onChanged: (val) {
//                                   setState(() {
...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('cd_ashma'),
//                                 ),
//                                 value: ashmaSelected,
//                                 onChanged: (val) {
//                                   setState(() {
...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('cd_thyroid'),
//                                 ),
...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('cd_epilepsy'),
//                                 ),
...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('cd_intestine'),
//                                 ),
//                                 value: cidSelected,
//                                 onChanged: (val) {
//                                   setState(() {
...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('cd_cva'),
//                                 ),
//                                 value: cvaSelected,
//                                 onChanged: (val) {
//                                   setState(() {
...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('cd_tumor'),
//                                 ),
...
//                             CheckboxListTile(
//                                 title: Text(
//                                   AppLocalizations.of(context).translate('physical_inactive'),
//                                 ),
...
//                                 ? CheckboxListTile(
//                                     title: Text(
//                                       AppLocalizations.of(context).translate('pregnancy'),
//                                     ),
