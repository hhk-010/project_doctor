...
class SignInViewM extends StatefulWidget {
  // method for toggling mcq view
  final Function questionsToogleView;
  const SignInViewM({Key key, this.questionsToogleView}) : super(key: key);

  @override
  _SignInViewMState createState() => _SignInViewMState();
}

class _SignInViewMState extends State<SignInViewM> {
  ...
  @override
  void initState() {
    SignInData.passwordVisible = false;
    super.initState();
  }
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      obscureText: !SignInData.passwordVisible,
                      onChanged: (val) {
                      ...
                      decoration: CStyle.getInputDecoration(context).copyWith(
                        ...
                        suffixIcon: IconButton(
                          icon: Icon(
                            SignInData.passwordVisible ? Icons.visibility : Icons.visibility_off,
                            color: Colors.deepOrange,
                          ),
                          onPressed: () {
                            setState(() {
                              SignInData.passwordVisible = !SignInData.passwordVisible;
                            });
                          },
                        ),
                      ),
          ...
          Align(
            ...
            child: Padding(
              ...
              child: RoundedLoadingButton(
                ...
                onPressed: () async {
                  if (await isInternet()) {
                    print(await isInternet());
                    if (SignInData.email != null && SignInData.password != null && SignInData.email.length >= 8) {
                      ...
                      if (authResult != null) {
                        ...
                        getFlushbar(context, "Hey", LocaleKeys.view_snack_error_snack_sign_in.tr())..show(context);
                      ...
                      getFlushbar(context, "Hey", "Fill in your email & password")..show(context);
                      _btnController.error();
                      Timer(Duration(seconds: 2), () {
                        _btnController.reset();
                      });
                    ...
                    getFlushbar(context, "Hey", LocaleKeys.view_snack_error_snack_connectivity.tr())..show(context);
                    _btnController.error();
                    Timer(Duration(seconds: 2), () {
                      _btnController.reset();
                    });
