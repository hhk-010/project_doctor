...
class _AboutUSState extends State<AboutUS> {
  ...
  String aboutUs =
      'Cura mobile app is developed by two certified medical practitioners trying to simplify the process of choosing the right medical specialty for the patient complaint';
                                  ...
                                  builder: (BuildContext context) {
                                    return AlertDialog(
                                      ...
                                      content: SingleChildScrollView(
                                        ...
                                        children: [
                                          Text(privacyPolicy, style: dialoge, textAlign: TextAlign.center),
                                        ],
                                      )),
                                      actions: <Widget>[
                                        FlatButton(
