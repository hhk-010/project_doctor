...
import 'package:project_doctor/pages/doctor_update_map.dart';
import 'package:project_doctor/pages/doctor_update_password.dart';
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => UpdatePassword01()));
                  },
                  child: RichText(
                    text: TextSpan(
